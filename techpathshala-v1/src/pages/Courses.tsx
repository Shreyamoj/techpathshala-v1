...
const courses = [
	{
		...
		description:
			"Learn Python from scratch with fun projects and games. Perfect for beginners who want to start their coding journey.",
	...
	},
	{
		...
		description:
			"Create beautiful websites from scratch. Learn HTML, CSS, and JavaScript to build responsive web applications.",
		image: "/placeholder.svg",
		duration: "10 weeks",
		students: "1,800+",
		rating: 4.9,
	...
	},
	{
		...
		description:
			"Master data analysis skills using Excel and Python. Learn to create charts, analyze trends, and make data-driven decisions.",
		image: "/placeholder.svg",
		duration: "6 weeks",
		students: "1,200+",
		rating: 4.7,
...
const Courses = () => {
	...
	const filteredCourses = courses.filter((course) => {
		...
		if (filter === "intermediate")
			return course.level.includes("Intermediate");
		return true;
	});
				...
				<div className="container mx-auto px-4">
					...
					<div className="text-center mb-12">
						...
						<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
							Master in-demand tech skills with hands-on projects designed
							specifically for Class 8-12 students
						</p>
					</div>
						...
						<Card className="max-w-2xl mx-auto">
							<CardContent className="p-8">
								...
								<p className="text-muted-foreground mb-6">
									Book a free consultation with our experts to find the perfect
